...
namespace Orleans.Runtime.Configuration
{
    ...
    public class NodeConfiguration : ITraceConfiguration, IStatisticsConfiguration
    {
        ...
        private static readonly int DEFAULT_MAX_ACTIVE_THREADS = 2;//Math.Max(4, System.Environment.ProcessorCount);
        ...
        public NodeConfiguration()
        {
            ...
            TraceToConsole = true; //ConsoleText.IsConsoleAvailable;
