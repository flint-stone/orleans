...
{
    internal class TestGrainEDFSchedulingStrategy : ISchedulingStrategy
    {
        ...
        public void OnReceivingControllerInstructions(IWorkItem workItem, ISchedulingContext context)
        {
            ...
            var workitemManager = wig.WorkItemManager as TestGrainEDFWorkItemManager;
        ...
        public void OnReceivingDownstreamInstructions(IWorkItem workItem, ISchedulingContext context)
        {
            ...
            var wim = wig.WorkItemManager as TestGrainEDFWorkItemManager;
        ...
        public WorkItemGroup CreateWorkItemGroup(IOrleansTaskScheduler ots, ISchedulingContext context)
        {
            ...
            wig.WorkItemManager = new TestGrainEDFWorkItemManager(this, wig);
        ...
        public void CheckForSchedulerHint(ActivationAddress sendingActivationAddress, GrainId upstream, Message msg)
        {
            ...
            {
                var wim = addressToWIG[sendingActivationAddress].WorkItemManager as TestGrainEDFWorkItemManager;
    ...
    internal class TestGrainEDFWorkItemManager : IWorkItemManager
    {
        private readonly TestGrainEDFSchedulingStrategy strategy;
        ...
        public TestGrainEDFWorkItemManager(ISchedulingStrategy iSchedulingStrategy, WorkItemGroup wig)
        {
            strategy = (TestGrainEDFSchedulingStrategy)iSchedulingStrategy;          
...
#if PQ_DEBUG
             _logger.Info($"{workItemGroup} Adding task {task}:{task.Id} with timestamp {windowId} ");
#endif
...
#if PQ_DEBUG
                _logger.Info($"Dequeue item {item}");
#endif
#if EDF_TRACKING
